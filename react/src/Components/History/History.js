...
const History = () =>{
    ...
    return(
        <div className={classes.history}>
            ...
            <span className={classes.history__text_span} >Thomas Cruis Mapother IV</span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut necessitatibus ex quae autem a odio Ut necessitatibus ex quae autem a odio
